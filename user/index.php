...
if (isset($_POST["loginbtn"])) {
    ...
    $select = mysqli_query($con, "SELECT * FROM admintbl WHERE username ='" . trim($usernametxt) . "'") or die(mysqli_error($con));
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Welcome Back to 2h_em</h1>
                                    </div>
